...
Usage:
    ...
    python conseq_fin_stage4_analysis.py --input-file custom_results.json
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('conseq_fin_stage4_analysis.log'),
...
class ONETAnalyzer:
    def __init__(self, results_file: str, csv_file: str):
        ...
        self.results = None
        self.df = None
        self.output_dir = Path("conseq_fin_stage4_visualizations")
    ...
    def analyze_task_distribution(self):
        ...
        plt.tight_layout()
        plt.savefig(self.output_dir / 'conseq_fin_stage4_task_distribution.png', dpi=300, bbox_inches='tight')
        plt.close()
    ...
    def analyze_automation_patterns(self):
        ...
        plt.tight_layout()
        plt.savefig(self.output_dir / 'conseq_fin_stage4_automation_patterns.png', dpi=300, bbox_inches='tight')
        plt.close()
    ...
    def analyze_automation_levels(self):
        ...
        plt.tight_layout()
        plt.savefig(self.output_dir / 'conseq_fin_stage4_automation_levels.png', dpi=300, bbox_inches='tight')
        plt.close()
    ...
    def analyze_tool_replacement(self):
        ...
        plt.tight_layout()
        plt.savefig(self.output_dir / 'conseq_fin_stage4_replaced_tools.png', dpi=300, bbox_inches='tight')
        plt.close()
    ...
    def analyze_occupations(self):
        ...
        plt.tight_layout()
        plt.savefig(self.output_dir / 'conseq_fin_stage4_occupations.png', dpi=300, bbox_inches='tight')
        plt.close()
    ...
    def generate_summary_report(self):
        ...
        # Save report
        report_file = self.output_dir / 'conseq_fin_stage4_analysis_report.json'
...
def main():
    ...
    parser.add_argument('--results-file', type=str, default='conseq_fin_stage4_results.json',
                       help='JSON results file from processing')
    parser.add_argument('--csv-file', type=str, default='conseq_fin_stage4_results.csv',
