...
* Click **Next** to start classifying.`
    ...
    // Tool 1 - Combined page with all questions
    {
        ...
        toolId: '@xxxnewbie/servers_annotatedMessage_6',
        toolDescription: 'Demonstrates how annotations can be used to provide metadata about content',
        serverName: 'Model Context Protocol Servers',
        serverDescription: 'Provide a collection of reference implementations showcasing the versatility and extensibility of the Model Context Protocol. Enable Large Language Models to securely and controllably access tools and data sources across various domains. Facilitate integration with numerous platforms and services through standardized MCP interfaces.',
    ...
    // Tool 2 - Combined page with all questions
    {
        ...
        toolIndex: 2,
        title: 'Tool 2/100',
        toolName: 'lookup_city_tool',
        toolId: 'jayden-hong/mcp_weatherwarning_server_lookup_city_tool_0',
        toolDescription: 'Query unique LocationID based on Chinese city name. Takes city name as string parameter and returns the LocationID needed for weather warning queries.',
        serverName: 'mcp_weatherwarning_server',
        serverDescription: '城市天气预警获取工具（灾害天气类型、预警颜色分级）',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 3 - Combined page with all questions
    {
        ...
        toolId: 'vapiai/mcp-server_get_phone_number_8',
        toolDescription: 'Gets details of a specific phone number',
        serverName: 'mcp-server',
        serverDescription: 'Vapi MCP Server',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 4 - Combined page with all questions
    {
        ...
        title: 'Tool 4/100',
        toolName: 'read_pdf',
        toolId: 'safe-swiss-cloud-ag/mcp_pdf_reader_read_pdf_0',
        toolDescription: 'Reads a single PDF document and extracts its content. Works with PDF files of any size, though the number of tokens passed to the model will be the limiting factor. Tested on Claude Desktop and LibreChat with Ollama.',
        serverName: 'mcp_pdf_reader',
        serverDescription: 'Model Context Protocol (MCP) server to read a single pdf document',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 5 - Combined page with all questions
    {
        ...
        toolIndex: 5,
        title: 'Tool 5/100',
        toolName: 'get_board_issues',
        toolId: 'orengrinker/jira-mcp-server_get_board_issues_2',
        toolDescription: 'Get board issues with advanced filtering options',
        serverName: 'jira-mcp-server',
        serverDescription: 'A comprehensive, production-ready Model Context Protocol (MCP) server for seamless Jira Cloud integration. This enhanced version provides advanced features, robust error handling, and extensive tooling for AI agents, automation systems, and custom applications.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 6 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 6,
        title: 'Tool 6/100',
        toolName: 'sign_psbt',
        toolId: 'odyssey98/bitcoinjs-mcp-server_sign_psbt_9',
        toolDescription: 'Sign PSBT with keys',
        serverName: 'bitcoinjs-mcp-server',
        serverDescription: 'MCP (Model Context Protocol) server for Bitcoin development using bitcoinjs-lib',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 7 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 7,
        title: 'Tool 7/100',
        toolName: 'manage_email_accounts',
        toolId: 'fuzzylabs/apollo-mcp_manage_email_accounts_10',
        toolDescription: 'Manage email accounts for sequences',
        serverName: 'apollo-mcp',
        serverDescription: 'MCP server for Apollo.io integration - enables AI assistants to search accounts, enrich contacts, and access sales intelligence data through natural language.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 8 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 8,
        title: 'Tool 8/100',
        toolName: 'query_events',
        toolId: 'dragonkhoi/mixpanel-mcp_query_events_0',
        toolDescription: 'Query Mixpanel events data to retrieve information about user events and interactions',
        serverName: 'mixpanel-mcp',
        serverDescription: 'MCP Server for Mixpanel API (talk to your Mixpanel data)',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 9 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 9,
        title: 'Tool 9/100',
        toolName: 'list_nearby_hotspots',
        toolId: 'siansiansu/ebird-mcp-server_list_nearby_hotspots_9',
        toolDescription: 'List birding hotspots within a specified distance of a location (e.g., List birding hotspots within 5 km of my current location)',
        serverName: 'ebird-mcp-server',
        serverDescription: 'A MCP server that integrates the eBird API to connect with an AI agent.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 10 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 10,
        title: 'Tool 10/100',
        toolName: 'loki_list_labels',
        toolId: 'gigapipehq/gigapipe-mcp_loki_list_labels_4',
        toolDescription: 'List all available Loki labels',
        serverName: 'gigapipe-mcp',
        serverDescription: 'Gigapipe MCP Server',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 11 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 11,
        title: 'Tool 11/100',
        toolName: 'get_youtube_transcript',
        toolId: 'jackhp/mcp-youtube-transcribe_get_youtube_transcript_0',
        toolDescription: 'Fetches transcripts from YouTube videos based on a search query. First attempts to retrieve a pre-existing, official transcript (manually created or auto-generated). If unavailable, downloads the video\'s audio and uses OpenAI\'s Whisper model for local AI-powered transcription. Parameters: query (required) - The search term for the YouTube video; force_whisper (optional, boolean, defaults to false) - If true, skips the check for an official transcript and generates one directly with Whisper.',
        serverName: 'mcp-youtube-transcribe',
        serverDescription: 'An AI-powered MCP server for fetching/generating YouTube video transcripts.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 12 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 12,
        title: 'Tool 12/100',
        toolName: 'get_free_slots',
        toolId: 'basicmachines-co/open-ghl-mcp_get_free_slots_21',
        toolDescription: 'Get available time slots for calendar using GET /calendars/{id}/free-slots endpoint',
        serverName: 'open-ghl-mcp',
        serverDescription: 'An open source Model Context Protocol server for GoHighLevel API v2 with OAuth',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 13 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 13,
        title: 'Tool 13/100',
        toolName: 'execute_query',
        toolId: 'oladejibidmus/digitalocean-database-mcp-server_execute_query_2',
        toolDescription: 'Execute SQL queries on connected databases with full SQL support for data retrieval, analysis, and manipulation',
        serverName: 'digitalocean-database-mcp-server',
        serverDescription: '',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
    ...
    // Tool 14 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 14,
        title: 'Tool 14/100',
        toolName: 'checkPackageDependencies',
        toolId: '@burger1984/azuredevops-mcp_checkPackageDependencies_83',
        toolDescription: 'Check package dependencies and vulnerabilities',
        serverName: 'Azure DevOps Integration Server',
        serverDescription: 'Provide seamless access to Azure DevOps work items, repositories, projects, boards, and sprints through a standardized MCP interface. Enable AI assistants and tools to manage and interact with Azure DevOps services efficiently. Simplify DevOps workflows by exposing comprehensive Azure DevOps functionalities as callable tools.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 15 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 15,
        title: 'Tool 15/100',
        toolName: 'chat',
        toolId: 'fujitsu-ai/mcp-server-for-mas-developments_chat_2',
        toolDescription: 'Initiate a conversation with the server, optionally using public knowledge bases or specific group contexts',
        serverName: 'mcp-server-for-mas-developments',
        serverDescription: 'MCP Server including Clients and Agents',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 16 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 16,
        title: 'Tool 16/100',
        toolName: 'search_ads',
        toolId: 'meilleursbiens/moteurimmo-mcp-server_search_ads_0',
        toolDescription: 'Recherche d\'annonces immobilières avec filtres selon divers critères (prix, surface, localisation, etc.) et options (garage, terrasse, jardin, etc.). Permet de trouver des propriétés correspondant à des critères spécifiques comme le type de bien, la localisation, le budget et les caractéristiques souhaitées.',
        serverName: 'moteurimmo-mcp-server',
        serverDescription: 'A MCP Server for MoteurImmo API',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 17 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 17,
        title: 'Tool 17/100',
        toolName: 'get_protein_annotations',
        toolId: 'augmented-nature/string-db-mcp-server_get_protein_annotations_3',
        toolDescription: 'Get detailed protein annotations and functional information',
        serverName: 'string-db-mcp-server',
        serverDescription: 'A comprehensive Model Context Protocol (MCP) server for accessing the STRING protein interaction database. This server provides powerful tools for protein network analysis, functional enrichment, and comparative genomics through the STRING API.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 19 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 19,
        title: 'Tool 19/100',
        toolName: 'playEffect',
        toolId: 'rhoegg/ufo-mcp-server_playEffect_2',
        toolDescription: 'Effect management tool to play pre-configured or custom lighting effects on the UFO device',
        serverName: 'ufo-mcp-server',
        serverDescription: 'MCP server for Dynatrace UFO',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 20 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 20,
        title: 'Tool 20/100',
        toolName: 'scan_project',
        toolId: 'nerfels/mind-map_scan_project_0',
        toolDescription: 'Performs comprehensive project scanning and creates nodes for files, directories, AST elements (functions, classes, interfaces, imports/exports), architectural patterns (7 types with confidence scoring), framework detection (React, Vue, Express, Django, Flask, pandas, NumPy, etc.), and error patterns. Supports force_rescan, include_analysis, and ast_analysis arguments.',
        serverName: 'mind-map',
        serverDescription: 'Model Context Protocol (MCP) server that provides intelligent project analysis and learning capabilities for Claude Code',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 21 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 21,
        title: 'Tool 21/100',
        toolName: 'todoist_subtask_create',
        toolId: '@greirson/mcp-todoist_todoist_subtask_create_20',
        toolDescription: 'Create a new subtask under a parent task in Todoist',
        serverName: 'Todoist Task Manager',
        serverDescription: 'Manage your Todoist tasks, projects, and comments seamlessly using natural language commands. Create, update, complete, and organize tasks and projects efficiently with support for bulk operations and rich task attributes. Enhance productivity by integrating Todoist task management directly into your workflow.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 22 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 22,
        title: 'Tool 22/100',
        toolName: 'update_note',
        toolId: 'myungbeans/blueprince-mcp_update_note_3',
        toolDescription: 'Updates existing notes with new content while preserving the structured format and metadata. Allows modification of previously created notes.',
        serverName: 'blueprince-mcp',
        serverDescription: 'MCP Server for local notes while playing through Blue Prince',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 23 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 23,
        title: 'Tool 23/100',
        toolName: 'list_hoverfly_mocks',
        toolId: 'kapishmalik/hoverfly-mcp-server_list_hoverfly_mocks_4',
        toolDescription: 'Lists all active mock APIs (request-response pairs)',
        serverName: 'hoverfly-mcp-server',
        serverDescription: 'Hoverfly MCP Server is a Spring Boot app that exposes Hoverfly via the Model Context Protocol (MCP), enabling AI assistants like Cursor or Copilot to manage mock APIs automatically. It helps simulate unavailable APIs with simple JSON, supporting full mock lifecycle control.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 24 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 24,
        title: 'Tool 24/100',
        toolName: 'verification.list_countries',
        toolId: 'thisishaykins/paystack-python-mcp_verification.list_countries_39',
        toolDescription: 'Retrieves a list of all countries.',
        serverName: 'paystack-python-mcp',
        serverDescription: 'A Paystack API Python MCP Server',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 25 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 25,
        title: 'Tool 25/100',
        toolName: 'jsr_get_current_user_invites',
        toolId: 'wyattjoh/jsr-mcp_jsr_get_current_user_invites_29',
        toolDescription: 'Get user\'s pending invites',
        serverName: 'jsr-mcp',
        serverDescription: 'Model Context Protocol server for the JSR (JavaScript Registry)',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 26 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 26,
        title: 'Tool 26/100',
        toolName: 'run_psscan',
        toolId: 'bornpresident/volatility-mcp-server_run_psscan_4',
        toolDescription: 'Scans for processes including ones that might be hidden or unlinked from the process list',
        serverName: 'volatility-mcp-server',
        serverDescription: 'A Model Context Protocol (MCP) server that integrates Volatility 3 memory forensics framework with Claude',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 27 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 27,
        title: 'Tool 27/100',
        toolName: 'cruise_control_get_kafka_cluster_load',
        toolId: 'brandon-powers/mcp-kafka_cruise_control_get_kafka_cluster_load_21',
        toolDescription: 'Retrieve cluster load metrics',
        serverName: 'mcp-kafka',
        serverDescription: 'An MCP server for Apache Kafka & its ecosystem.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 28 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 28,
        title: 'Tool 28/100',
        toolName: 'force_terminate',
        toolId: '@2511319/desktopcommandermcp_force_terminate_15',
        toolDescription: 'Force terminate a running terminal session.\n                        \n                        This command can be referenced as "DC: ..." or "use Desktop Commander to ..." in your instructions.',
        serverName: 'Desktop Commander',
        serverDescription: 'Enable powerful terminal command execution, process management, and advanced file editing capabilities through an AI assistant. Seamlessly search, update, and manage files, run interactive terminal commands, and automate tasks without API token costs. Enhance your development workflow with surgical code edits, comprehensive audit logging, and dynamic configuration management.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 29 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 29,
        title: 'Tool 29/100',
        toolName: 'prepare_database_migration',
        toolId: 'neondatabase/mcp-server-neon_prepare_database_migration_17',
        toolDescription: 'Initiates a database migration process. Critically, it creates a temporary branch to apply and test the migration safely before affecting the main branch.',
        serverName: 'mcp-server-neon',
        serverDescription: 'Interact with the Neon serverless Postgres platform',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 30 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 30,
        title: 'Tool 30/100',
        toolName: 'terminate_sandbox',
        toolId: 'milkymap/mcp4modal_sandbox_terminate_sandbox_1',
        toolDescription: 'Stop and clean up running sandboxes with controlled resource management and shutdown',
        serverName: 'mcp4modal_sandbox',
        serverDescription: 'A powerful Model Context Protocol (MCP) server for seamless cloud-based sandbox management using https://modal.com',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 31 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 31,
        title: 'Tool 31/100',
        toolName: 'delete_data',
        toolId: 'mafzaal/d365fo-client_delete_data_6',
        toolDescription: 'Delete entity records from D365 F&O. Requires entity key and returns success status.',
        serverName: 'd365fo-client',
        serverDescription: 'A comprehensive MCP server for Microsoft Dynamics 365 Finance & Operations (D365 F&O) that provides easy access to OData endpoints, metadata operations, label management, and AI assistant integration.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 32 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 32,
        title: 'Tool 32/100',
        toolName: 'get_available_folders',
        toolId: 'juananpe/arxiv-research-server-mcp_get_available_folders_2',
        toolDescription: 'List all available topic folders in the papers directory. Accessed via resource papers://folders',
        serverName: 'arxiv-research-server-mcp',
        serverDescription: 'Arxiv Research Server MCP: Search, organize, and summarize arXiv papers using MCP tools and resources.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 33 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 33,
        title: 'Tool 33/100',
        toolName: 'run_capsules',
        toolId: 'codeocean/codeocean-mcp-server_run_capsules_1',
        toolDescription: 'Run Code Ocean capsules. Requires CODEOCEAN_DOMAIN and CODEOCEAN_TOKEN environment variables.',
        serverName: 'codeocean-mcp-server',
        serverDescription: 'Code Ocean MCP Server',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 34 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 34,
        title: 'Tool 34/100',
        toolName: 'listGoogleDocs',
        toolId: 'a-bonus/google-docs-mcp_listGoogleDocs_10',
        toolDescription: 'Find and list Google Documents in Drive',
        serverName: 'google-docs-mcp',
        serverDescription: 'Google Docs MCP is an MCP server (primarily for use in Claude Desktop) that gains full access to your google docs and allows claude to make direct edits and formatting. Use cases include writing notes, letters, resumes, creating tables, etc.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 36 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 36,
        title: 'Tool 36/100',
        toolName: 'delete-one',
        toolId: 'mongodb-js/mongodb-mcp-server_delete-one_22',
        toolDescription: 'Delete a single document from a MongoDB collection',
        serverName: 'mongodb-mcp-server',
        serverDescription: 'Both MongoDB Community Server and MongoDB Atlas are supported.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 37 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 37,
        title: 'Tool 37/100',
        toolName: 'gmail_delete_draft',
        toolId: 'j3k0/mcp-google-workspace_gmail_delete_draft_6',
        toolDescription: 'Delete draft emails by ID.',
        serverName: 'mcp-google-workspace',
        serverDescription: 'MCP Server for Gmail and Calendar',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 38 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 38,
        title: 'Tool 38/100',
        toolName: 'get_top_pools',
        toolId: 'sailfish-finance/educhain-ai-agent-kit_get_top_pools_4',
        toolDescription: 'Get a list of top liquidity pools by TVL on SailFish DEX',
        serverName: 'educhain-ai-agent-kit',
        serverDescription: 'This MCP (Model Context Protocol) server is integrated into Claude\'s MCP and maintained by SailFish',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 39 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 39,
        title: 'Tool 39/100',
        toolName: 'gh_search_repositories',
        toolId: 'huangjien/devops-mcps_gh_search_repositories_0',
        toolDescription: 'Search and view GitHub repository details using qualifiers like in:name,description,readme, user:USERNAME, org:ORGNAME, language:LANGUAGE, stars:>N, forks:<N, created:YYYY-MM-DD, pushed:>YYYY-MM-DD, topic:TOPIC-NAME, license:LICENSE-KEYWORD. Requires GITHUB_TOKEN environment variable.',
        serverName: 'devops-mcps',
        serverDescription: 'A DevOps MCP server, python implementation, release in docker mode.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 40 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 40,
        title: 'Tool 40/100',
        toolName: 'find_drums_track',
        toolId: 'adamjmurray/producer-pal_find_drums_track_0',
        toolDescription: 'Find and identify drum tracks in Ableton Live, including drum rack mapping which tells the AI which pitches correspond to which drum sounds',
        serverName: 'producer-pal',
        serverDescription: 'AI assistant for music composition inside Ableton Live using an MCP server in a Max for Live device',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 41 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 41,
        title: 'Tool 41/100',
        toolName: 'get_scene_info',
        toolId: 'igamenovoer/blender-remote_get_scene_info_1',
        toolDescription: 'Retrieve information about the current Blender scene, including objects present in the scene and their properties.',
        serverName: 'blender-remote',
        serverDescription: 'Remote control Blender with Python and MCP server',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 42 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 42,
        title: 'Tool 42/100',
        toolName: 'create_issue_with_images',
        toolId: 'jaqarx/github-project-mcp_create_issue_with_images_2',
        toolDescription: 'Create an issue with embedded images. Parameters: owner, repo, title, body, images (array), labels, assignees. Images can be: local file paths, URLs, or objects with path/url and alt text',
        serverName: 'github-project-mcp',
        serverDescription: 'A Model Context Protocol (MCP) server for managing GitHub projects and issues using GitHub\'s GraphQL API.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 43 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 43,
        title: 'Tool 43/100',
        toolName: 'token_ohlc_data',
        toolId: 'moralisweb3/moralis-mcp-server_token_ohlc_data_9',
        toolDescription: 'Retrieve daily OHLC (Open, High, Low, Close) price data for tokens over a specified time period with trend analysis',
        serverName: 'moralis-mcp-server',
        serverDescription: '',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
    ...
    // Tool 44 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 44,
        title: 'Tool 44/100',
        toolName: 'element_clicking',
        toolId: 'go-rod/rod-mcp_element_clicking_0',
        toolDescription: 'Enables clicking on web page elements for browser automation and interaction',
        serverName: 'rod-mcp',
        serverDescription: 'Model Context Protocol Server of Rod',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 45 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 45,
        title: 'Tool 45/100',
        toolName: 'group_similar_functions',
        toolId: 'juspay/fdep-mcp-server_group_similar_functions_34',
        toolDescription: 'Group functions by similarity',
        serverName: 'fdep-mcp-server',
        serverDescription: 'Model Context Protocol (MCP) Server for Advanced Haskell Code Analysis - 40+ Comprehensive Analysis Tools',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 46 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 46,
        title: 'Tool 46/100',
        toolName: 'get_project_details',
        toolId: 'jpicklyk/task-orchestrator_get_project_details_28',
        toolDescription: 'Get detailed information about a specific project',
        serverName: 'task-orchestrator',
        serverDescription: 'An MCP server that manages features and tasks across multiple projects.  Useful for having the AI take PRD documents, breaking them into features and tasks for use across multiple interactions.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 47 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 47,
        title: 'Tool 47/100',
        toolName: 'olamap_speed_limits',
        toolId: 'rdsdd2021/olamap-mcp-server_olamap_speed_limits_16',
        toolDescription: 'Get road speed limits with Indian road standards fallback (Urban: 40-60 km/h, Highways: 80-100 km/h, Expressways: 100-120 km/h, Residential: 30-40 km/h). Provides speed limit information for roads.',
        serverName: 'olamap-mcp-server',
        serverDescription: 'A Model Context Protocol server for OlaMap API integration with intelligent trip planning capabilities',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 48 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 48,
        title: 'Tool 48/100',
        toolName: 'data_share_interactions',
        toolId: 'chakra-network/mcp-server_data_share_interactions_1',
        toolDescription: 'Interact with subscribed data shares using natural language - for example, if you have subscribed to a financial data share, you can ask questions like \'What is the stock price of Tesla?\' Requires DB Session Key from Chakra Console',
        serverName: 'mcp-server',
        serverDescription: 'Native integration with Anthropic\'s Model Context Protocol.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 49 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 49,
        title: 'Tool 49/100',
        toolName: 'get_api_endpoint_info',
        toolId: 'juzisuan965/apifox-mcp_get_api_endpoint_info_0',
        toolDescription: 'Retrieves API endpoint definition information from Apifox. Accepts projectId and endpointId as required parameters. Returns detailed API definitions including request headers, request methods, request parameters, response parameters, response headers, etc. Requires APIFOX_AUTH environment variable for authentication.',
        serverName: 'apifox-mcp',
        serverDescription: 'apifox mcp server',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 50 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 50,
        title: 'Tool 50/100',
        toolName: 'query_rules_graphql',
        toolId: 'stonecircle82/tufin-mcp_query_rules_graphql_5',
        toolDescription: 'Queries firewall rules using Tufin SecureTrack GraphQL API. Supports TQL (Tufin Query Language) filter parameter to filter rules (e.g., \'disabled true\'). Returns rule details including id, name, and count.',
        serverName: 'tufin-mcp',
        serverDescription: 'Bridge Tufin APIs to AI workflows: An open-source REST server with RBAC for SecureTrack and SecureChange integration.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 51 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 51,
        title: 'Tool 51/100',
        toolName: 'set_position',
        toolId: 'anglerfishchess/chess-uci-mcp_set_position_2',
        toolDescription: 'Set the current chess position',
        serverName: 'chess-uci-mcp',
        serverDescription: 'MCP server to connect to the chess engines using UCI protocol',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 52 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 52,
        title: 'Tool 52/100',
        toolName: 'update_link',
        toolId: '@gitmaxd/dubco-mcp-server-npm_update_link_1',
        toolDescription: 'Update an existing short link on dub.co',
        serverName: 'Dub.co (Unofficial) MCP Server',
        serverDescription: 'Create, update, and delete short links effortlessly with this server. Integrate seamlessly with AI assistants to manage your Dub.co links through a standardized interface. Enhance your link management experience with powerful tools at your fingertips.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 53 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 53,
        title: 'Tool 53/100',
        toolName: 'query_character',
        toolId: 'sfbb/mcp-mongodb-novel-server_query_character_0',
        toolDescription: 'Get character details from MongoDB including name, description, traits, and relationships. Parameters: {"character_id": "string"}',
        serverName: 'mcp-mongodb-novel-server',
        serverDescription: 'A Model Context Protocol (MCP) server that provides an interface between LLMs and MongoDB databases, optimized for small context windows (3k tokens). Specially for novel.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 54 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 54,
        title: 'Tool 54/100',
        toolName: 'mark_emails',
        toolId: 'wyattjoh/jmap-mcp_mark_emails_4',
        toolDescription: 'Mark emails with keywords - set seen status (read/unread) or flagged status (flagged/unflagged) for up to 100 email IDs',
        serverName: 'jmap-mcp',
        serverDescription: 'A Model Context Protocol (MCP) server that provides tools for interacting with JMAP (JSON Meta Application Protocol) email servers. Built with Deno and using the jmap-jam client library.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 55 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 55,
        title: 'Tool 55/100',
        toolName: 'move_mouse',
        toolId: 'claude-did-this/mcpcontrol_move_mouse_5',
        toolDescription: 'Move the mouse cursor to a specific position with precision',
        serverName: 'mcpcontrol',
        serverDescription: 'MCP server for Windows OS automation',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 56 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 56,
        title: 'Tool 56/100',
        toolName: 'clickup_delete_folder',
        toolId: 'nazruden/clickup-mcp-server_clickup_delete_folder_14',
        toolDescription: 'Deletes a Folder. Requires: folder_id.',
        serverName: 'clickup-mcp-server',
        serverDescription: 'A Model Context Protocol server implementation for ClickUp integration, enabling AI assistants to interact with ClickUp workspaces.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 57 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 57,
        title: 'Tool 57/100',
        toolName: 'wechat_upload_img',
        toolId: 'xwang152-jack/wechat-official-account-mcp_wechat_upload_img_2',
        toolDescription: 'Upload images needed for article messages, does not count against media library limits. Supports operation: upload (upload image via file path or base64 data). Supported formats: JPG, PNG (max 1MB). Does not count against the 100,000 image limit in the Official Account media library. Returns image URL that can be directly used in article messages.',
        serverName: 'wechat-official-account-mcp',
        serverDescription: '微信公众号MCP服务器 - WeChat Official Account MCP Server',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 58 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 58,
        title: 'Tool 58/100',
        toolName: 'commit',
        toolId: 'mcginleyr1/jj-mcp-server_commit_2',
        toolDescription: 'Create a new commit with a message. Accepts optional parameters: repoPath (path to the jj repository root) and cwd (working directory to run the command in).',
        serverName: 'jj-mcp-server',
        serverDescription: 'MCP server to use JJ',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 59 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 59,
        title: 'Tool 59/100',
        toolName: 'mdb_list_commands',
        toolId: 'paulmramirez/yamcs-mcp-server_mdb_list_commands_2',
        toolDescription: 'List available commands from the Mission Database',
        serverName: 'yamcs-mcp-server',
        serverDescription: 'Model Context Protocol (MCP) Server for Yamcs Mission Control System',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 60 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 60,
        title: 'Tool 60/100',
        toolName: 'manage_ticket_forms',
        toolId: 'omaralsayeed/zendesk-mcp-ts_manage_ticket_forms_5',
        toolDescription: 'Manage Zendesk ticket forms and their structure',
        serverName: 'zendesk-mcp-ts',
        serverDescription: 'Model Context Protocol server that exposes Zendesk Admin and Support APIs as tools for AI assistants (Cursor,Claude). It provides typed endpoints for ticket fields/forms, statuses, users, organizations, triggers, views and more, making them easy. Built with TypeScript and the official MCP SDK, npx-ready and designed for secure, reliable operations.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 61 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 61,
        title: 'Tool 61/100',
        toolName: 'data_analysis_template',
        toolId: 'bubobot-team/mcp-prompt-optimizer_data_analysis_template_23',
        toolDescription: 'Data insights and reporting templates for data analysis workflows',
        serverName: 'mcp-prompt-optimizer',
        serverDescription: 'Advanced MCP server providing cutting-edge prompt optimization tools with research-backed strategies',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 62 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 62,
        title: 'Tool 62/100',
        toolName: 'create_entities',
        toolId: '@jasonmorganson/memory_create_entities_0',
        toolDescription: 'Create multiple new entities in the knowledge graph',
        serverName: 'Knowledge Graph Memory Server',
        serverDescription: 'Enable your agents to remember user information across chats by utilizing a local knowledge graph. This server allows for the creation, management, and retrieval of entities and their relationships, enhancing personalized interactions. Improve user engagement by maintaining context and continuity in conversations.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 63 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 63,
        title: 'Tool 63/100',
        toolName: 'send_file',
        toolId: 'wati-io/whatsapp-api-mcp-server_send_file_7',
        toolDescription: 'Send a file (image, video, raw audio, document) to a specified recipient via WhatsApp.',
        serverName: 'whatsapp-api-mcp-server',
        serverDescription: '',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
    ...
    // Tool 64 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 64,
        title: 'Tool 64/100',
        toolName: 'network_requests',
        toolId: 'coderzzy/llm-mcp-server-template_network_requests_3',
        toolDescription: 'Handles network requests as an MCP server capability',
        serverName: 'llm-mcp-server-template',
        serverDescription: 'LLM-MCP server 开发的模版项目',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 65 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 65,
        title: 'Tool 65/100',
        toolName: 'add_attachment',
        toolId: 'cosmix/confluence-mcp_add_attachment_8',
        toolDescription: 'Add an attachment to a Confluence page. The \`fileContentBase64\` should be the base64 encoded string of the file content. Input: pageId (required), filename (required), fileContentBase64 (required - base64 encoded file content), comment (optional)',
        serverName: 'confluence-mcp',
        serverDescription: 'A Model Context Protocol server for Confluence.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 66 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 66,
        title: 'Tool 66/100',
        toolName: 'get_account_balance',
        toolId: '8bitsats/solana-explorer-mcp-server_get_account_balance_1',
        toolDescription: 'Get the SOL balance of a Solana account in lamports',
        serverName: 'solana-explorer-mcp-server',
        serverDescription: '',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
    ...
    // Tool 67 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 67,
        title: 'Tool 67/100',
        toolName: 'get_person_details',
        toolId: 'ukenn2112/bangumimcp_get_person_details_14',
        toolDescription: 'Get detailed information about a specific person by person_id',
        serverName: 'bangumimcp',
        serverDescription: 'bgm.tv MCP Server',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 68 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 68,
        title: 'Tool 68/100',
        toolName: 'get_shader_info',
        toolId: 'wilsonchenghy/shadertoy-mcp_get_shader_info_0',
        toolDescription: 'Retrieves information on any shader on ShaderToy, allowing the LLM to query and read shader details from the website',
        serverName: 'shadertoy-mcp',
        serverDescription: 'This MCP server lets LLMs to interact with the ShaderToy API, allowing LLMs to learn from compute shaders examples and enabling them to create complex GLSL shaders that they are previously not capable of.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 69 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 69,
        title: 'Tool 69/100',
        toolName: 'getCalendars',
        toolId: 'aanerud/mcp-microsoft-office_getCalendars_22',
        toolDescription: 'List all user calendars',
        serverName: 'mcp-microsoft-office',
        serverDescription: 'an local MCP server you can run on your env, connecting you to Microsoft Graph, and the complete M365 eco system.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 70 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 70,
        title: 'Tool 70/100',
        toolName: 'unifi_list_wlans',
        toolId: 'sirkirby/unifi-network-mcp_unifi_list_wlans_30',
        toolDescription: 'Lists all wireless networks (WLANs) configured in the controller',
        serverName: 'unifi-network-mcp',
        serverDescription: 'MCP server implementation for the UniFi network application',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 71 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 71,
        title: 'Tool 71/100',
        toolName: 'run_query_collect_and_stop',
        toolId: 'cledar/flink-mcp_run_query_collect_and_stop_4',
        toolDescription: 'Executes a query, fetches up to max_rows (default 5) within max_seconds (default 15.0), then stops the job if a jobID is present and closes the operation. Requires sessionHandle and query string.',
        serverName: 'flink-mcp',
        serverDescription: 'MCP server for Apache Flink SQL Gateway',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 72 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 72,
        title: 'Tool 72/100',
        toolName: 'rik_business_register',
        toolId: 'stefanoamorelli/estonia-ai-kit_rik_business_register_0',
        toolDescription: 'Access Estonian Business Register (RIK) data including company information, registry details, and business entity data from daily snapshots of open data files. Requires downloading data files first.',
        serverName: 'estonia-ai-kit',
        serverDescription: '🇪🇪 AI SDK for Estonian government services - including MCP servers for Business Register, Tax Board, Open Data Portal. Connect Claude, GPT & other AI models to Estonia\'s digital infrastructure.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 73 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 73,
        title: 'Tool 73/100',
        toolName: 'delete_dns_records',
        toolId: 'mattcollins/spaceship-mcp_delete_dns_records_3',
        toolDescription: 'Deletes DNS records from a domain. Parameters: domain (string, required) - The domain name; records (array, required) - Array of DNS records to delete with name (subdomain) and type (A, AAAA, CNAME, MX, TXT, etc.). Requires Spaceship API key with dnsrecords:write permission.',
        serverName: 'spaceship-mcp',
        serverDescription: 'An MCP (Model Context Protocol) server for the Spaceship API, providing tools to manage DNS records.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 74 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 74,
        title: 'Tool 74/100',
        toolName: 'search_papers_by_author',
        toolId: 'scipenai/aminer-mcp-server_search_papers_by_author_2',
        toolDescription: 'Search papers published by specific authors. Parameters: author (string, required) - author name; page (number, optional) - page number, default 0; size (number, optional) - papers per page, default 10, max 10; order (string, optional) - sort by \'year\' or \'n_citation\'',
        serverName: 'aminer-mcp-server',
        serverDescription: 'A Model Context Protocol (MCP) server providing powerful academic paper search and analysis functionality through the AMiner API.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 75 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 75,
        title: 'Tool 75/100',
        toolName: 'resolve_doi',
        toolId: 'bright-l01/networkx-mcp-server_resolve_doi_0',
        toolDescription: 'Resolve DOI to publication metadata using CrossRef API - accesses 156+ million academic papers',
        serverName: 'networkx-mcp-server',
    ...
    // Tool 76 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 76,
        title: 'Tool 76/100',
        toolName: 'get_users',
        toolId: 'zenml-io/mcp-zenml_get_users_0',
        toolDescription: 'Retrieves information about users in the ZenML server',
        serverName: 'mcp-zenml',
        serverDescription: 'Interact with your MLOps and LLMOps pipelines through your',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 77 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 77,
        title: 'Tool 77/100',
        toolName: 'create_collection',
        toolId: '@ryanmaule/metabase-mcp_create_collection_11',
        toolDescription: 'Create a new collection in Metabase',
        serverName: 'Metabase Analytics Integration Server',
        serverDescription: 'Enable AI assistants to seamlessly interact with your Metabase analytics platform. Access dashboards, cards, databases, and execute queries directly through conversational AI. Manage and manipulate your analytics data with ease and security using API key or session authentication.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 78 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 78,
        title: 'Tool 78/100',
        toolName: 'get_sobjects_list',
        toolId: 'ryu-727/salesforce-mcp_get_sobjects_list_3',
        toolDescription: 'Get list of all available SObjects',
        serverName: 'salesforce-mcp',
        serverDescription: 'MCP Server for Salesforce API integration',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 79 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 79,
        title: 'Tool 79/100',
        toolName: 'ida_get_function_decompiled_by_name',
        toolId: '@mxiris-reverse-engineering/ida-mcp-server_ida_get_function_decompiled_by_name_2',
        toolDescription: 'Get decompiled pseudocode for a function by name',
        serverName: 'IDA MCP Server',
        serverDescription: 'Interact with and automate IDA database operations using Large Language Models. Leverage powerful tools to read and search your IDA databases programmatically, enhancing your development workflow.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 80 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 80,
        title: 'Tool 80/100',
        toolName: 'list_databases',
        toolId: 'ccabanillas/notion-mcp_list_databases_0',
        toolDescription: 'List and query Notion databases in the workspace',
        serverName: 'notion-mcp',
        serverDescription: 'A Model Context Protocol (MCP) server implementation for Notion integration, providing a standardized interface for interacting with Notion\'s API.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 81 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 81,
        title: 'Tool 81/100',
        toolName: 'get_security_test_status',
        toolId: 'sandraschi/vboxmcp_get_security_test_status_34',
        toolDescription: 'Get the status of a security test',
        serverName: 'vboxmcp',
        serverDescription: 'FastMCP 2.0 server for VirtualBox management through Claude Desktop - Austrian efficiency MCP template',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 82 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 82,
        title: 'Tool 82/100',
        toolName: 'authorize_client',
        toolId: 'ksankaran/mcp-b2c-oauth_authorize_client_2',
        toolDescription: 'Used by MCP Clients to initiate authorization flow with the server - redirects to Google OAuth2 login',
        serverName: 'mcp-b2c-oauth',
        serverDescription: 'MCP Server secured by B2C Google OAuth',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 83 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 83,
        title: 'Tool 83/100',
        toolName: 'create_worksheet',
        toolId: '@haris-musa/excel-mcp-server_create_worksheet_6',
        toolDescription: 'Create new worksheet in workbook.',
        serverName: 'Excel MCP Server',
        serverDescription: 'Manipulate Excel files seamlessly without requiring Microsoft Excel installed. Create, read, modify workbooks, apply formatting, generate charts, and manage worksheets through AI agents. Supports both local and remote usage with stdio and SSE transport protocols.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 84 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 84,
        title: 'Tool 84/100',
        toolName: 'list_storage_containers',
        toolId: 'jcallico/py-az-mcp_list_storage_containers_14',
        toolDescription: 'List all Storage Containers in a Storage Account',
        serverName: 'py-az-mcp',
        serverDescription: 'An Azure MCP Server',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 85 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 85,
        title: 'Tool 85/100',
        toolName: 'deposit_to_strategy',
        toolId: 'lin0304/puffer.fi-defi-mcp_deposit_to_strategy_4',
        toolDescription: 'Generate protocol-specific deposit instructions with real Puffer Finance smart contract addresses, ready-to-execute transaction calldata, accurate gas cost estimates, and required token approval information',
        serverName: 'puffer.fi-defi-mcp',
        serverDescription: 'Complete MCP server for Puffer Finance with DeFi strategies and cross-chain bridging',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 86 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 86,
        title: 'Tool 86/100',
        toolName: 'create_figma_designs',
        toolId: 'ihiteshsharma/figma-mcp-server_create_figma_designs_0',
        toolDescription: 'Create new Figma designs by describing them, including rectangles, circles, text, frames, buttons, cards, and other UI components',
    ...
    // Tool 87 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 87,
        title: 'Tool 87/100',
        toolName: 'get_file_metadata',
        toolId: 'zhongweili/nanobanana-mcp-server_get_file_metadata_4',
        toolDescription: 'Retrieve metadata information about uploaded files through MCP resources',
    ...
    // Tool 88 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 88,
        title: 'Tool 88/100',
        toolName: 'update_calendar_booking',
        toolId: 'delorenj/mcp-server-gohilvl_update_calendar_booking_12',
        toolDescription: 'Update existing calendar bookings and appointments',
        serverName: 'mcp-server-gohilvl',
        serverDescription: 'A set of tools to connect gohighlevel data to your LLMs',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 89 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 89,
        title: 'Tool 89/100',
        toolName: 'hf_repository_utilities',
        toolId: 'procreations-official/huggingmcp_hf_repository_utilities_10',
        toolDescription: 'Advanced repository utilities including comprehensive repository health checks with scoring system, and backup information creation for repositories. Requires repo_id and repo_type parameters',
        serverName: 'huggingmcp',
        serverDescription: 'Model Context Protocol (MCP) server for HuggingFace integration - lets Claude create, manage, and interact with HuggingFace spaces, models, datasets, and collections',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 90 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 90,
        title: 'Tool 90/100',
        toolName: 'list-projects',
        toolId: '@taylor-lindores-reeves/mcp-github-projects_list-projects_1',
        toolDescription: 'List all projects for a user or organization',
        serverName: 'MCP GitHub Projects',
        serverDescription: 'Streamline your project management with integrated tools and resources. Enhance collaboration and efficiency by leveraging the power of the Model Context Protocol to connect your projects with real-world data and actions. Simplify workflows and improve productivity with a standardized approach to managing your GitHub projects.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 91 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 91,
        title: 'Tool 91/100',
        toolName: 'ha_activate_scene',
        toolId: 'homeassistant-ai/ha-mcp_ha_activate_scene_7',
        toolDescription: 'Activate a Home Assistant scene to apply predefined device states',
        serverName: 'ha-mcp',
        serverDescription: 'The Unofficial and Awesome Home Assistant MCP Server',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 92 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 92,
        title: 'Tool 92/100',
        toolName: 'oscp_register',
        toolId: 'andreibesleaga/oscp-sdk_oscp_register_0',
        toolDescription: 'Register with OSCP v2.0 flexibility provider endpoint. Requires token authentication, version_url array with base_url and version fields, and X-Request-ID header.',
        serverName: 'oscp-sdk',
        serverDescription: 'OSCP SDK & AI MCP Server Implementation for EV Charging Open Smart Charging Protocol',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 94 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 94,
        title: 'Tool 94/100',
        toolName: 'smart_click',
        toolId: 'inkbytefo/screenmonitormcp_smart_click_4',
        toolDescription: 'Click UI elements using natural language descriptions like \'Save button\' or \'Email input field\'',
        serverName: 'screenmonitormcp',
        serverDescription: 'A REVOLUTIONARY Model Context Protocol (MCP) server! Gives AI real-time vision capabilities and enhanced UI intelligence power. This isn\'t just screen capture - it gives AI the power to truly "see" and understand your digital world!',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 95 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 95,
        title: 'Tool 95/100',
        toolName: 'flash_program',
        toolId: 'adancurusul/embedded-debugger-mcp_flash_program_12',
        toolDescription: 'Program ELF, HEX, or BIN firmware files to flash memory',
        serverName: 'embedded-debugger-mcp',
        serverDescription: 'A Model Context Protocol server for embedded debugging with probe-rs - supports ARM Cortex-M, RISC-V debugging via J-Link, ST-Link, and more',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 96 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 96,
        title: 'Tool 96/100',
        toolName: 'zotero_get_collection_items',
        toolId: '@54yyyu/zotero-mcp_zotero_get_collection_items_4',
        toolDescription: 'Get all items in a specific Zotero collection.',
        serverName: 'Zotero MCP',
        serverDescription: 'Connect your Zotero research library with AI assistants to discuss papers, get summaries, and analyze citations. Enhance your research workflow by seamlessly integrating your library with Claude and other tools.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 97 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 97,
        title: 'Tool 97/100',
        toolName: 'API-retrieve-a-page',
        toolId: '@quoda-co/notion-mcp-server_API-retrieve-a-page_10',
        toolDescription: 'Retrieve a page',
        serverName: 'Notion API Server',
        serverDescription: 'Enable seamless interaction with your Notion workspace through natural language commands. Automate content retrieval, page creation, and commenting by leveraging the Notion API via an MCP server. Enhance your productivity by integrating Notion data and actions directly into your AI workflows.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 98 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 98,
        title: 'Tool 98/100',
        toolName: 'anki_get_study_progress',
        toolId: 'muxuuu/talktoanki_anki_get_study_progress_13',
        toolDescription: 'Get detailed learning progress statistics including new, young, and mature card counts, and review metrics',
        serverName: 'talktoanki',
        serverDescription: 'A powerful MCP server that enables seamless integration between AI assistants and Anki through AnkiConnect',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 99 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 99,
        title: 'Tool 99/100',
        toolName: 'delete_relations',
        toolId: '@myangsun/loc-memory-server_delete_relations_5',
        toolDescription: 'Delete multiple relations from the knowledge graph',
        serverName: 'Memory Graph',
        serverDescription: 'Remember user details and preferences across conversations. Organize facts into connected profiles for richer, long-term context. Search, update, and automatically extract locations to keep memories accurate and actionable.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
    ...
    // Tool 100 - Combined page with all questions
    {
        type: 'tool_combined',
        toolIndex: 100,
        title: 'Tool 100/100',
        toolName: 'dft_calculations',
        toolId: 'phelanshao/openmm-mcp-server_dft_calculations_1',
        toolDescription: 'Perform density functional theory (DFT) calculations using the Abacus DFT engine for quantum mechanical calculations',
        serverName: 'openmm-mcp-server',
        serverDescription: 'OpenMM, an open-source platform for molecular dynamics (MD) simulations, is supported by an MCP server that offers a structured communication interface for task submission, management, and execution.',
        q21Text: 'Q2.1: What is the highest autonomy level enabled by this server (choose action if one action tool)?',
        q21Choices: [
            { value: 'perception', text: 'Perception: ways a model may perceive the environment - e.g., reading files, monitoring sensors, fetching API data' },
            { value: 'reasoning', text: 'Reasoning: ways that a model may reason beyond inference - e.g., calculating results, planning actions, analyzing patterns' },
