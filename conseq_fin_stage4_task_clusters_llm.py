...
def l3_to_l2_validation():
    ...
    return Task(
        dataset=json_dataset("conseq_fin_stage4_task_clusters_validation_l3_to_l2.jsonl"),
        solver=[
...
def l2_to_l1_validation():
    ...
    return Task(
        dataset=json_dataset("conseq_fin_stage4_task_clusters_validation_l2_to_l1.jsonl"),
        solver=[
            system_message(VALIDATION_SYSTEM_PROMPT),
            generate()
        ],
...
def l3_to_l1_validation():
    ...
    return Task(
        dataset=json_dataset("conseq_fin_stage4_task_clusters_validation_l3_to_l1.jsonl"),
        solver=[
            system_message(VALIDATION_SYSTEM_PROMPT),
            generate()
        ],
...
def subset_l2_l3_validation():
    ...
    return Task(
        dataset=json_dataset("conseq_fin_stage4_task_clusters_validation_subset_l2_l3.jsonl"),
        solver=[
            system_message(VALIDATION_SYSTEM_PROMPT),
            generate()
        ],
