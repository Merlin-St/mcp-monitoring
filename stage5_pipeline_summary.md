...
**File**: `stage5_task_main.py`

### Usage
```bash
# Minimal run (uses all defaults)
python stage5_task_main.py --run
...
- `stage5_tasks_cluster_names.csv`: O*NET hierarchy (18,796 tasks)
...
The `stage5_task_clusters_run.py` system provides validation of the O*NET task clustering:

### Validation Files
- `stage5_task_clusters_validation_l2_to_l1.jsonl`: Validates Level 2→Level 1 mappings
- `stage5_task_clusters_validation_l3_to_l2.jsonl`: Validates Level 3→Level 2 mappings  
- `stage5_task_clusters_validation_l3_to_l1.jsonl`: Validates Level 3→Level 1 mappings
- `stage5_task_clusters_validation_subset_l2_l3.jsonl`: Validates L2/L3 subset relationships
