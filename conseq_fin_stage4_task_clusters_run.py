...
Usage:
    python conseq_fin_stage4_task_clusters_run.py --k2 400
    python conseq_fin_stage4_task_clusters_run.py --k2 400 --skip-validation
    python conseq_fin_stage4_task_clusters_run.py --model openai/o3-mini --max-connections 100
"""
...
# Import our modules
from conseq_fin_stage4_task_clusters_embeddings import build_two_level_hierarchy, get_cluster_statistics
from conseq_fin_stage4_task_clusters_data import (
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('conseq_fin_stage4_task_clusters_run.log'),
    ...
    try:
        ...
        if not args.only_validation:
            ...
            if args.contrastive == 'yes':
                ...
                embeddings_file = 'conseq_fin_stage4_task_clusters_embeddings_onet.npz'
...
from conseq_fin_stage4_task_clusters_llm import generate_cluster_names
...
""")
        ...
        if not args.skip_validation:
            ...
            for task_type, _ in validation_tasks:
                ...
                jsonl_file = f'conseq_fin_stage4_task_clusters_validation_{task_type}.jsonl'
            ...
            for task_type, description in validation_tasks:
                ...
                log_dir = run_inspect_eval('conseq_fin_stage4_task_clusters_llm.py', f'{task_type}_validation', f'{task_type}_validation', args.model, args.max_connections)
        ...
        summary_file = 'conseq_fin_stage4_task_clusters_summary.json'
        ...
        summary_clean = convert_numpy_types(summary)
        summary_file = 'conseq_fin_stage4_task_clusters_summary_error.json'
        with open(summary_file, 'w') as f:
