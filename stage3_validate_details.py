...
Part of the stage3 validation pipeline.
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('stage3_validate_details.log'),
...
def save_detailed_results(analysis: Dict[str, Any], patterns: Dict[str, Any]):
    ...
    with open('stage3_validate_details_analysis.json', 'w') as f:
        json.dump(output, f, indent=2)
    
    logger.info("Detailed analysis saved to stage3_validate_details_analysis.json")
